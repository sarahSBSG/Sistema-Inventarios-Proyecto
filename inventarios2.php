  ...
  <script>
    ...
    <nav>
      ...
      <ul>
        ...
        <li><a href="inventarios.php">Limpieza</a></li>
        <li><a class="active" href="inventarios2.php">Jardineria</a></li>
        <li>
...
<div class="row d-flex justify-content-center">
    ...
    <div class="col-md-7 p-3">
      <form method="POST">
        ...
        <?php
        include "controlador/eliminar_producto2.php";
        include "php_inv/conexion_jar.php";
        include "controlador/registro_productos2.php";
        ?>
    ...
    include "php_inv/conexion_jar.php";
    $sql=$conexion_jar->query(" select * from inventario_jardineria ");
    ?>
...
<!-- AQUI SE CIERRAN LOS DIVS, EL BODY Y HTML -->
    <div class="col-md-5 p-3">
      ...
      <div class="mb-5 text-center">
          <a href="php_inv/generar_reporte2.php" class="btn btn-verde-clarito" name="btngenerareporte" value="ok">GENERAR REPORTE</a>
      </div>
  
      <form action="controlador/modificar_producto2.php" method="GET">
          <div class="mb-2">
  ...
  <!-- Formulario para eliminar producto -->
      <form action="controlador/eliminar_producto2.php" method="GET" class="mt-3">
        <div class="mb-2">
      ...
      <form method="POST" class="mt-5">
        ...
        <?php
          ...
          if(isset($_POST['btnbuscar'])) {
            ...
            $sql = $conexion_jar->prepare("SELECT COUNT(*) as cantidad FROM inventario_jardineria WHERE nom_producto = ?");
